...
public class IterativeOrdering2 implements IOrdering {
    ...
    public IterativeOrdering2(int pivotLength, String infile, int readLen, int bufSize, int k, long[] initialOrdering, int roundSamples, int rounds, int elementsToPush, int pushBy) {
    ...
    public IterativeOrdering2(int pivotLength, String infile, int readLen, int bufSize, int k) {
    ...
    public IterativeOrdering2(int pivotLength, String infile, int readLen, int bufSize, int k, int roundSamples, int rounds, int elementsToPush, int pushBy) {
    ...
    public void initFrequency() throws IOException {
        ...
        while (keepSample && (describeline = bfrG.readLine()) != null) {
            ...
            if (Arrays.stream(pmerFrequency).max().getAsLong() > 25-Math.min(roundNumber/10, 15)) {
