...
public class IterativeOrdering5 implements IOrdering {
    ...
    public IterativeOrdering5(int pivotLength, String infile, int readLen, int bufSize, int k, long[] initialOrdering) {
    ...
    public IterativeOrdering5(int pivotLength, String infile, int readLen, int bufSize, int k) {
    ...
    public IterativeOrdering5(int pivotLength, String infile, int readLen, int bufSize, int k, int roundSamples, int rounds, int elementsToPush, int statisticsSamples, double maskRatio, double percentagePunishment) {
